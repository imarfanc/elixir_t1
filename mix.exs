defmodule ElixirT1.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind elixir_t1", "esbuild elixir_t1"],
      "assets.deploy": [
        "tailwind elixir_t1 --minify",
        "esbuild elixir_t1 --minify",
        "phx.digest"
      ],
